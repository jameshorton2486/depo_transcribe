...
class DepoProApp(ctk.CTk):
    ...
    def create_main_container(self):
        ...
        source_frame = ctk.CTkFrame(
            self.container, fg_color="#1e293b", border_width=1, border_color="#334155"
        )
        source_frame.pack(fill="x", pady=(5, 20), ipady=10)
        self.file_path_var = tk.StringVar(
            value="C:/Users/james/Downloads/04-09-26 Biana Caram MD 01_1.mp3"
        )
        ...
        config_card = ctk.CTkFrame(
            config_col, fg_color="#1e293b", border_width=1, border_color="#334155"
        )
        ...
        ctk.CTkComboBox(
            config_card,
            values=["Nova-3 (Ultra Precision)", "Nova-2 (Fast)", "Whisper-V3"],
            height=35,
            fg_color="#0f172a",
            border_color="#334155",
        ...
        ctk.CTkComboBox(
            config_card,
            values=["ENHANCED (Fair Audio)", "STANDARD (Clean Audio)", "ISOLATED"],
            height=35,
            fg_color="#0f172a",
            border_color="#334155",
        ).pack(fill="x", padx=20, pady=5)
        info_box = ctk.CTkFrame(
            config_card, fg_color="#1e293b", border_width=1, border_color="#1d4ed8"
        )
        info_box.pack(fill="x", padx=20, pady=20)
        ctk.CTkLabel(
            info_box,
            text="Est. Time: ~4m 30s",
        ...
        details_card = ctk.CTkFrame(
            details_col, fg_color="#1e293b", border_width=1, border_color="#334155"
        )
        ...
        ctk.CTkEntry(
            meta_grid,
            placeholder_text="e.g. CV-2024",
            height=35,
            fg_color="#0f172a",
            border_color="#334155",
        ).grid(row=1, column=0, sticky="ew", padx=(0, 5), pady=(0, 10))
        ctk.CTkLabel(
            meta_grid,
        ...
        ctk.CTkEntry(
            ...
            fg_color="#0f172a",
            border_color="#334155",
        ).grid(row=1, column=1, sticky="ew", padx=(5, 0), pady=(0, 10))
        ctk.CTkLabel(
            meta_grid,
            text="FIRST NAME",
            font=ctk.CTkFont(size=10, weight="bold"),
        ...
        ctk.CTkEntry(
            meta_grid, height=35, fg_color="#0f172a", border_color="#334155"
        ).grid(row=3, column=0, sticky="ew", padx=(0, 5), pady=(0, 10))
        ctk.CTkLabel(
            meta_grid,
            text="LAST NAME",
            font=ctk.CTkFont(size=10, weight="bold"),
        ...
        ctk.CTkEntry(
            meta_grid, height=35, fg_color="#0f172a", border_color="#334155"
        ).grid(row=3, column=1, sticky="ew", padx=(5, 0), pady=(0, 10))
        ctk.CTkLabel(
            details_card,
            text="SAVE LOCATION",
            font=ctk.CTkFont(size=10, weight="bold"),
        ...
        ctk.CTkButton(
            loc_frame, text="Change", width=80, height=35, fg_color="#334155"
        ).pack(side="left")
        self.action_hub = ctk.CTkFrame(
            self.container, fg_color="#1e293b", border_width=1, border_color="#334155"
        )
        ...
        self.progress_bar = ctk.CTkProgressBar(
            self.action_hub, height=10, border_width=0, progress_color="#2563eb"
        )
        ...
        ctk.CTkButton(utils_frame, text="Reporter Notes", **btn_config).pack(
            side="left", expand=True, padx=5
        )
        ctk.CTkButton(utils_frame, text="Output Folder", **btn_config).pack(
            side="left", expand=True, padx=5
        )
        ctk.CTkButton(utils_frame, text="View Transcript", **btn_config).pack(
            side="left", expand=True, padx=5
        )
        ctk.CTkButton(
            utils_frame,
