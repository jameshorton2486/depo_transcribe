...
def test_classify_assigns_structural_types():
    blocks = classify_blocks(
        [
            {"speaker": "speaker 1", "text": "\tQ.\tState your name.", "type": "paragraph"},
            {"speaker": "speaker 2", "text": "\tA.\tBianca Caram.", "type": "paragraph"},
            {"speaker": "speaker 3", "text": "BY MS. MALONEY:", "type": "paragraph"},
            {"speaker": "court reporter", "text": "Do you solemnly swear the testimony you give is true?", "type": "paragraph"},
