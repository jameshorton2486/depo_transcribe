...
def test_question_detection():
    ...
    # after audio review. See docs/plans/_archive/verbatim_punctuation_plan_2026-05-12.md.
...
def test_em_dash_normalization():
    ...
    # See docs/plans/_archive/verbatim_punctuation_plan_2026-05-12.md Rule 3.
...
def test_interrogative_without_punctuation_gets_period():
    ...
    # docs/plans/_archive/verbatim_punctuation_plan_2026-05-12.md Rule 2.
