...
Q line:  \t + "Q." + "  " + text
         ...
         One tab indents to stop 1 (720 twips / 0.5"), then "Q."
         is followed by TWO LITERAL SPACES before the question
         text. This is the correct Texas UFM format. Reporter
         (Miah Bardot) confirmed 2026-04-28; the prior
         2026-04-27 entry that mandated two tabs was incorrect
         and has been reverted.

A line:  \t + "A." + "  " + text
         Example: \tA.  Yes, sir.
         Same one-tab + label + two-spaces construction as Q.
